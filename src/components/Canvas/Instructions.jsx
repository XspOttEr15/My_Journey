...
const Instructions = ({ isVisible }) => {
  return (
    <div className={`instructions-overlay${isVisible ? ' visible' : ''}`}>
      ...
      <button id="button"  type="button" class="mt-5 text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200  font-medium rounded-lg  text-2xl px-5 py-2.5 text-center me-2 mb-2">CLICK HERE TO PLAY</button>
    </div>
  );
};
