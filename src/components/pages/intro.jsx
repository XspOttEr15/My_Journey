  ...
  return (
    <div className={`instructions-overlay ${fadeEffect}`}>
      ...
      <p className="lg:text-2xl md:text-lg text-center pt-5  lg:px-44 md:px-24">
        ...
        เว็บไซต์แบบสามมิติ โดยอุปกรณ์ที่รองรับ ได้แก่ PC  Notebook และ Tablet หรือ Ipad  จะแสดงผลได้ดีที่สุดบน PC ขนาดหน้าจอ 1920x1080, เว็บไซต์ My Journey ออกแบบให้ทำงานกับบราว์เซอร์ที่รองรับ WebGL ในการแสดงผลโมเดลสามมิติบนเว็บไซต์ ได้แก่ Google Chrome, Safari, และ Microsoft Edge แนะนำให้ใช้บราว์เซอร์ Microsoft Edge ในการเข้าชมเว็บไซต์   
      </p>
      <button
